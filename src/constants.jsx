...
export const PERSONAJES = [
  ...
  {
    id:'ryu', nombre:'Ryu', nivelDesbloqueo:21, glowColor:'#e8d0b0',
    rects: [
      [3,0,10,3,'#3a2010'],[2,1,12,2,'#5a3010'],[1,1,2,2,'#3a2010'],[13,1,2,2,'#3a2010'],
      [3,3,10,1,'#cc2020'],
      [4,4,8,4,'#c89070'],[3,5,1,3,'#c89070'],[12,5,1,3,'#c89070'],
      [5,5,2,1,'#1a1200'],[9,5,2,1,'#1a1200'],
      [6,7,4,1,'#8a5040'],
      [3,8,10,4,'#e8e8e0'],[2,9,12,3,'#e8e8e0'],
      [4,12,8,1,'#202020'],
      [1,9,2,4,'#c89070'],[13,9,2,4,'#c89070'],
      [3,13,4,3,'#d8d8d0'],[9,13,4,3,'#d8d8d0'],
    ],
    frases: [
      "El camino del guerrero no termina. Siempre hay más que aprender.",
      "La verdadera fuerza nace del dominio de uno mismo.",
      "Cada golpe en el saco es un paso hacia quien quieres ser.",
      "No huyas de tu lado oscuro. Conócelo y contrólalo.",
      "El entrenamiento de hoy es la victoria de mañana.",
      "La disciplina sin propósito es esfuerzo perdido.",
      "Quien se conoce a sí mismo no tiene miedo de ningún rival.",
      "La perfección en un solo movimiento vale más que mil mediocres.",
      "El verdadero reto no está fuera. Está dentro.",
      "Nunca uses tu poder para dañar sin razón.",
      "La mente tranquila golpea más fuerte que la ira.",
      "El camino del Hadoken es el camino de la voluntad.",
      "Hoy no compitas contra nadie. Solo contra quien fuiste ayer.",
      "La fuerza que no controlas te destruye. Domínala.",
      "Sigue entrenando. El horizonte siempre se aleja un poco más.",
    ],
  },
  {
    id:'ken', nombre:'Ken', nivelDesbloqueo:22, glowColor:'#e0c030',
    rects: [
      [3,0,10,3,'#c0a010'],[2,1,12,3,'#e0c020'],[1,2,3,4,'#c0a010'],[13,2,3,4,'#c0a010'],
      [3,3,10,1,'#cc2020'],
      [4,4,8,4,'#d4a070'],[3,5,1,3,'#d4a070'],[12,5,1,3,'#d4a070'],
      [5,5,2,1,'#2040c0'],[9,5,2,1,'#2040c0'],
      [5,7,6,1,'#9a5040'],
      [3,8,10,4,'#cc2020'],[2,9,12,3,'#cc2020'],
      [4,12,8,1,'#202020'],
      [1,9,2,4,'#d4a070'],[13,9,2,4,'#d4a070'],
      [3,13,4,3,'#aa1818'],[9,13,4,3,'#aa1818'],
    ],
    frases: [
      "¡La vida es demasiado corta para no darlo todo!",
      "Puedes tener estilo Y ser el mejor. No son opuestos.",
      "La rivalidad sana te hace crecer. Busca a alguien que te supere.",
      "Confía en ti. Si no lo haces tú, ¿quién lo hará?",
      "El fuego del Shoryuken viene de las ganas, no de la técnica.",
      "Ganar con clase o perder con elegancia. Siempre con carácter.",
      "La amistad verdadera aguanta la competencia más dura.",
      "Hoy sé el tipo de persona que tu yo de hace un año envidiaría.",
      "¡El que no arriesga no gana! Tira el Shoryuken aunque falle.",
      "La confianza en exceso es arrogancia. La justa, es poder.",
      "Entrenar sin disfrutarlo es desperdiciar la mitad del potencial.",
      "La pasión enciende el fuego. La disciplina lo mantiene.",
      "Nunca subestimes a nadie. Los rivales inesperados son los mejores maestros.",
      "Haz lo que amas con todo lo que tienes. El resto se arregla solo.",
      "¡El mejor momento para empezar fue ayer. El segundo mejor es ahora!",
    ],
  },
  {
    id:'leonardo', nombre:'Leonardo', nivelDesbloqueo:23, glowColor:'#2060c0',
    rects: [
      [2,0,12,3,'#8a6030'],[1,1,14,3,'#a07040'],
      [4,3,8,5,'#508050'],[3,4,1,3,'#508050'],[12,4,1,3,'#508050'],
      [3,4,10,2,'#2060c0'],[2,5,3,1,'#2060c0'],[11,5,3,1,'#2060c0'],
      [4,4,2,2,'#e8e8e8'],[10,4,2,2,'#e8e8e8'],[5,5,1,1,'#1a1a40'],[11,5,1,1,'#1a1a40'],
      [6,7,4,1,'#608060'],
      [4,8,8,4,'#90c050'],[3,9,10,3,'#90c050'],
      [2,9,2,5,'#508050'],[12,9,2,5,'#508050'],
      [1,9,2,4,'#508050'],[13,9,2,4,'#508050'],
      [4,13,3,3,'#508050'],[9,13,3,3,'#508050'],
    ],
    frases: [
      "Un líder no ordena. Inspira con sus acciones.",
      "La disciplina diaria es lo que separa el héroe del que sueña con serlo.",
      "Proteger lo que amas requiere conocer tus propios límites.",
      "La honra no está en ganar. Está en luchar con integridad.",
      "Un equipo unido supera a cualquier enemigo.",
      "El entrenamiento en las sombras prepara el momento bajo los focos.",
      "Ser responsable no es una carga. Es la marca del carácter.",
      "La paciencia de un samurai no es debilidad. Es estrategia.",
      "Quien lidera desde el miedo, pierde. Quien lidera desde la convicción, inspira.",
      "Las katanas no matan. La voluntad detrás de ellas sí.",
      "Hoy haz algo que mañana te enorgullezca.",
      "El camino del bushido exige presencia total en cada acto.",
      "No te rindas cuando estés cansado. Descansa y vuelve.",
      "La familia que eliges vale tanto como la que te dieron.",
      "Cowabunga puede esperar. Primero la misión.",
    ],
  },
  {
    id:'kinnikuman', nombre:'Kinnikuman', nivelDesbloqueo:24, glowColor:'#cc2020',
    rects: [
      [3,0,10,8,'#cc2020'],[2,1,12,6,'#cc2020'],[1,3,2,4,'#cc2020'],[13,3,2,4,'#cc2020'],
      [5,2,1,5,'#f0f0f0'],[5,4,3,1,'#f0f0f0'],[7,2,2,2,'#f0f0f0'],[7,5,2,2,'#f0f0f0'],
      [4,3,2,2,'#f0f0f0'],[10,3,2,2,'#f0f0f0'],[5,4,1,1,'#1a1a40'],[11,4,1,1,'#1a1a40'],
      [5,6,6,1,'#f0f0f0'],
      [3,8,10,4,'#d4a070'],[2,9,12,3,'#d4a070'],
      [3,12,10,2,'#cc2020'],[2,13,12,1,'#cc2020'],
      [0,9,3,5,'#d4a070'],[13,9,3,5,'#d4a070'],
      [3,14,4,2,'#d4a070'],[9,14,4,2,'#d4a070'],
    ],
    frases: [
      "¡Los músculos del corazón son más importantes que los del brazo!",
      "Rendirse no está en el diccionario de un luchador verdadero.",
      "¡Aunque te tiren al suelo 10 veces, levántate 11!",
      "La amistad es el golpe más poderoso de todos.",
      "No importa si eres el más fuerte. Importa si eres el más decidido.",
      "¡El que lucha con honor nunca pierde de verdad!",
      "Los rivales de hoy son los amigos de mañana si luchas limpio.",
      "El entrenamiento ridículo de hoy es la hazaña épica de mañana.",
      "¡Un campeón no nace! ¡Se forja en cada caída!",
      "La fe en uno mismo mueve montañas. Y también oponentes.",
      "Haz reír mientras luchas. La alegría también es fuerza.",
      "Cada derrota es un maestro disfrazado de humillación.",
      "¡Nakama! Sin tu equipo, eres la mitad de lo que puedes ser.",
      "El ridículo de hoy es la leyenda de mañana. ¡Adelante!",
      "¡Muscle Spark! Cuando ya no puedes más, da un paso más.",
    ],
  },
]
